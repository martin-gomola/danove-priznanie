    ...
    <div className="min-h-screen flex flex-col bg-gray-50 text-gray-900">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                title="Exportovať XML (DPFO priznanie)"
              >
              ...
              <button
                ...
                className="p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors"
                title="Importovať z XML (DPFO priznanie)"
              >
      ...
      <footer className="shrink-0 border-t border-gray-200 bg-white/80 backdrop-blur-xl mt-auto">
        <div className="max-w-4xl mx-auto px-6 py-3">
          ...
          <p className="text-[11px] text-gray-400 text-center mt-3 pt-3 border-t border-gray-100">
