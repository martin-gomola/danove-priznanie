/**
 * XML Output Template for DPFO typ B 2025
 *
 * Complete empty JSON structure matching the official XSD schema.
 * Based on slovensko-digital/priznanie-digital with additions
 * for Príloha č.2 (dividends), Tabuľka 2/3, and Osobitné záznamy.
 */

import { TAX_YEAR } from '../tax/constants';

/* eslint-disable @typescript-eslint/no-explicit-any */
export type OutputJson = Record<string, any>;

const outputBasis: OutputJson = {
  dokument: {
    hlavicka: {
      dic: '',
      datumNarodenia: '',
    ...
    telo: {
      ...
      r45: '',
      r46: '',
      r47: { rok: '2020', udaje: { r02: '', r03: '', r04: '' } },
      r48: { rok: '2021', udaje: { r02: '', r03: '', r04: '' } },
      r49: { rok: '2022', udaje: { r02: '', r03: '', r04: '' } },
      r50: { rok: '2023', udaje: { r02: '', r03: '', r04: '' } },
      r50a: { rok: '2024', udaje: { r02: '', r04: '' } },
      r51: '',
      r52: '',
      r53: '',
      r54: '',
      ...
      r153: {
        ...
        rodicA: { rodneCislo: '', priezvisko: '', meno: '' },
        rodicB: { rodneCislo: '', priezvisko: '', meno: '' },
        bolZverenyDoStarostlivosti: '0',
      },
      osobitneZaznamy: {
        uvadza: '0',
        udajeOprijmoch: Array.from({ length: 6 }, () => ({
          kodStatu: '',
          druhPrimuPar: '',
          druhPrimuOds: '',
          druhPrimuPis: '',
      ...
      pril1cPar30caVydavkySport: {
        r01: { s01Od: '', s01Do: '', s02: '', s03: '' },
        r02: { s01Od: '', s01Do: '', s02: '', s03: '' },
        r03: { s01Od: '', s01Do: '', s02: '', s03: '' },
        r04: { s01Od: '', s01Do: '', s02: '', s03: '' },
        r05: { s01Od: '', s01Do: '', s02: '', s03: '' },
        r06: '',
        r07: '',
        r08: '',
      },
