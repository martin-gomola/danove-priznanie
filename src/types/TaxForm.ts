...
export interface DividendEntry {
  ...
  amountUsd: string; // gross USD dividends for the year (before withholding)
  amountEur: string; // auto-calculated EUR equivalent
  withheldTaxUsd: string; // tax withheld abroad in USD (e.g., 15% W-8BEN)
  withheldTaxEur: string; // auto-calculated EUR equivalent
}
