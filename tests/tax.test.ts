  ...
  it('pr9 = pr7 × 7% (dividend tax)', () => {
    const result = calculateTax(
      form({
        ...
        dividends: {
          enabled: true,
          entries: [{ id: '1', ticker: 'X', country: '840', countryName: 'USA', amountUsd: '100', amountEur: '1000', withheldTaxUsd: '0', withheldTaxEur: '0' }],
          ecbRate: '1', ecbRateOverride: false,
        },
      })
    );
  ...
  it('pr17 = min(pr16, pr14) (foreign tax credit)', () => {
    const result = calculateTax(
      form({
        ...
        dividends: {
          enabled: true,
          entries: [{ id: '1', ticker: 'X', country: '840', countryName: 'USA', amountUsd: '100', amountEur: '1000', withheldTaxUsd: '150', withheldTaxEur: '150' }],
          ecbRate: '1', ecbRateOverride: false,
        },
      })
    );
  ...
  it('pr28 = dividend tax after credit', () => {
    const result = calculateTax(
      form({
        ...
        dividends: {
          enabled: true,
          entries: [{ id: '1', ticker: 'X', country: '840', countryName: 'USA', amountUsd: '100', amountEur: '1000', withheldTaxUsd: '30', withheldTaxEur: '30' }],
          ecbRate: '1', ecbRateOverride: false,
        },
      })
    );
